...
static GUI_NUM_MODE guiNumMode = GUI_NUMMODE_SPACE;
static uint16_t * iconBuffer;
static uint8_t pixel_limit_flag = 0;
static GUI_RECT pixel_limit_rect;
static const uint32_t GUI_Pow10[10] = {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000};
