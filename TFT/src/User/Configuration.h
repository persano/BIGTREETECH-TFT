 ...
 *                P3: [min: 0, max: 11]
 *                P4: [min: 0, max: 11]
 *   Options: [OFF (port disabled): 0, 2400: 1, 9600: 2, 19200: 3, 38400: 4, 57600: 5, 115200: 6, 230400: 7, 250000: 8, 500000: 9, 921600: 10, 1000000: 11, 1958400: 12, 2000000: 13]
 */
#define SP_1 8  // Default: 6 — changed to 250000 for Artillery Genius Pro
